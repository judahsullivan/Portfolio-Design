import { ap as qe, aq as Xe } from './sanity-84ed9559.js';
function Ue(G, Q) {
 ...
 */ (function (G, Q) {
  (function (y) {
    ...
    if (
      ...
      (Z = function (e, r) {
        var n = r.signal;
        return xe(e, { headers: r.headers, credentials: r.credentials, cache: r.cache }).then(
          function (t) {
    ...
    var De = function () {
      try {
        return new J().decode(new ve().encode('test'), { stream: !0 }) === 'test';
      } catch (e) {
        console.debug(
...
`),
    ...
    ge.prototype.open = function (e, r, n, t, o, a, s) {
      ...
      (e.onprogress = function () {
        ...
        (e.withCredentials = a);
      for (var f in s) Object.prototype.hasOwnProperty.call(s, f) && e.setRequestHeader(f, s[f]);
      return e.send(), e;
    };
    function Ee(e) {
      this._headers = e;
    ...
    function we() {}
    we.prototype.open = function (e, r, n, t, o, a, s) {
      var c = null,
        f = new ee(),
        d = f.signal,
        u = new J();
      return (
        Z(o, {
          ...
          .then(function (i) {
            return (
              (c = i.body.getReader()),
              r(i.status, i.statusText, i.headers.get('Content-Type'), new Ee(i.headers)),
              new Ae(function (l, D) {
                var $ = function () {
                  c.read()
                    .then(function (C) {
    ...
    var re = -1,
      ...
      ie = function (e) {
        return Math.min(Math.max(e, Ne), Ie);
      },
      X = function (e, r, n) {
        try {
    ...
    function He() {
      return (h != null && 'withCredentials' in h.prototype) || ue == null ? new h() : new ue();
    }
    ...
    function je(e, r, n) {
      ...
      var t = !!n.withCredentials,
        ...
        $ = l != null && typeof l != 'string' ? new l() : D == null ? new we() : new ge(),
        C = void 0,
        E = 0,
        x = re,
        U = '',
...
`.charCodeAt(0))
                ...
                if (w !== L) {
                  ...
                  var O = m.slice(se, M - 1),
                    N = m.slice(M + (M < g && m.charCodeAt(M) === ' '.charCodeAt(0) ? 1 : 0), g);
                  O === 'data'
                    ? ((U += `
`),
                      (U += N))
          ...
          if (r.slice(0, 5) !== 'data:' && r.slice(0, 5) !== 'blob:' && c !== '') {
            ...
            (v =
              S === -1
                ? r
                : r.slice(0, S + 1) +
                  r.slice(S + 1).replace(/(?:^|&)([^=&]*)(?:=[^&]*)?/g, function (N, B) {
                    return B === o ? '' : N;
                  })),
    ...
    h != null && (K == null || !('withCredentials' in K.prototype)) && (be = A),
      (function (e) {
        ...
        (e.EventSourcePolyfill = A), (e.NativeEventSource = K), (e.EventSource = be);
      });
  })(
    typeof globalThis > 'u'
      ? typeof window < 'u'
...
var Be = de.exports,
  Re = Be.EventSourcePolyfill;
const Ge = Xe(Re),
  We = Ue({ __proto__: null, default: Ge }, [Re]);
export { We as b };
