...
export default function RecentProjects() {
  return (
    <section className="w-full mx-auto min-h-screen flex-col gap-10 flex justify-around overflow-hidden ">
      <h4 className="font-basement text-theme-accent text-4xl tracking-tight font-extrabold">
        Recent Projects
      </h4>
      ...
      <button className=" place-self-center w-[150px] h-[150px] rounded-full bg-gray-600 text-white">
        View All Projects
      </button>
    </section>
  );
...
const Link = ({ heading, imgSrc, subheading, href }) => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-sm">Date | MM-DD-YYY</p>
        <motion.span className="relative z-10 font-aileron block text-4xl font-extrabold text-theme-base transition-colors duration-500 group-hover:text-theme-accent ">
        ...
        <span className="relative z-10 mt-2 block text-base text-theme-muted max-w-lg">
          {subheading}
        </span>
        <span className="space-x-2">
          <span className="bg-theme-accent p-1 rounded-sm">tags</span>
          <span className="bg-theme-accent p-1 rounded-sm">tags</span>
          <span className="bg-theme-accent p-1 rounded-sm">tags</span>
        </span>
      </div>
